...
def efficient_net(width_coefficient,
    ...
    d5_1 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(16, 16), padding='same')(Concatenate_waiting[6])
    ...
    d5_2 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(8, 8), padding='same')(
    ...
    d5_3 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(4, 4), padding='same')(
        Concatenate_waiting[6])
    ...
    d5_4 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(2, 2), padding='same')(
        Concatenate_waiting[6])
    d5_4 = tf.keras.layers.Conv2D(filters=base_channel, kernel_size=(3, 3),
                                  kernel_initializer=CONV_KERNEL_INITIALIZER, padding='same')(d5_4)

    d4 = tf.keras.layers.concatenate([d5_4, e4_4, e3_4, e2_4, e1_4])
    d4 = tf.keras.layers.Conv2D(filters=base_channel * 5, kernel_size=(3, 3),
    ...
    d4_2 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(4, 4), padding='same')(
        d4)
    ...
    d4_1 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(8, 8), padding='same')(
        d4)
    ...
    d3 = tf.keras.layers.Conv2D(filters=base_channel * 5, kernel_size=(3, 3),
    ...
    d3_1 = tf.keras.layers.Conv2DTranspose(base_channel, (3, 3), strides=(4, 4), padding='same')(
        d3)
    ...
    d2 = tf.keras.layers.Conv2D(filters=base_channel * 5, kernel_size=(3, 3),
    ...
    d1 = tf.keras.layers.Conv2D(filters=base_channel * 5, kernel_size=(3, 3),
    ...
    output1 = tf.keras.layers.Conv2D(3, (3, 3), kernel_initializer='he_normal', padding='same')(output1)
    output1 = tf.multiply(output1, sort_layer)

    output2 = tf.keras.layers.Conv2DTranspose(3, (3, 3), strides=(4, 4), padding='same')(d2)
    output2 = tf.keras.layers.Conv2D(3, (3, 3), kernel_initializer='he_normal', padding='same')(output2)
    output2 = tf.multiply(output2, sort_layer)

    output3 = tf.keras.layers.Conv2DTranspose(3, (3, 3), strides=(8, 8), padding='same')(d3)
    output3 = tf.keras.layers.Conv2D(3, (3, 3), kernel_initializer='he_normal', padding='same')(output3)
    output3 = tf.multiply(output3, sort_layer)

    output4 = tf.keras.layers.Conv2DTranspose(3, (3, 3), strides=(16, 16), padding='same')(d4)
    output4 = tf.keras.layers.Conv2D(3, (3, 3), kernel_initializer='he_normal', padding='same')(output4)
    ...
    output5 = tf.keras.layers.Conv2D(3, (3, 3), kernel_initializer='he_normal', padding='same')(output5)
